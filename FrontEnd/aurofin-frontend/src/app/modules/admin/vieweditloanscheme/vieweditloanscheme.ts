...
import { CollateralRequirementDto } from '../../../entity/CollateralRequirementDto';
...
@Component({
  selector: 'app-vieweditloanscheme',
  standalone: false,
  templateUrl: './vieweditloanscheme.html',
  styleUrl: './vieweditloanscheme.css'
})
export class Vieweditloanscheme {
loanForm!: FormGroup;
