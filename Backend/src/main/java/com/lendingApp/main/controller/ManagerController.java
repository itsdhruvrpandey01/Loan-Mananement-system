...
public class ManagerController {
    ...
    public ResponseEntity<ApplicationResponse> rejectLoan(@PathVariable UUID loanId, @RequestParam(required = false) String reason) {
    ...
    public ResponseEntity<UpdatedEmployeeResponseDto> updateEmployeeDetails(@PathVariable UUID employeeId,@RequestBody UpdateEmployeeDetailsDto employeeDetailsDto) {
    ...
    public ResponseEntity<AddressResponseDto> postMethodName(@PathVariable UUID employeeId,@RequestBody AddressDto addressDto) {
